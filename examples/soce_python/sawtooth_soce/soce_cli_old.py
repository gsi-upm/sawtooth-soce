...
def add_create_parser(subparsers, parent_parser):
    parser = subparsers.add_parser(
        'create',
        help='Creates a new soce game',
        description='Sends a transaction to start an soce game with the '
...
def add_list_parser(subparsers, parent_parser):
    parser = subparsers.add_parser(
        'list',
        help='Displays information for all soce games',
        description='Displays information for all soce games in state, showing '
...
def add_show_parser(subparsers, parent_parser):
    parser = subparsers.add_parser(
        'show',
        help='Displays information about an soce game',
        description='Displays the soce game <name>, showing the players, '
...
def add_take_parser(subparsers, parent_parser):
    parser = subparsers.add_parser(
        'take',
        help='Takes a space in an soce game',
        description='Sends a transaction to take a square in the soce game '
...
def create_parser(prog_name):
    ...
    parser = argparse.ArgumentParser(
        ...
        'Noughts and Crosses) by sending SOCE transactions.',
        parents=[parent_parser])
...
def do_list(args):
    ...
    if game_list is not None:
        ...
        raise SoceException("Could not retrieve game listing.")
...
def do_show(args):
    ...
    if data is not None:
        ...
        raise SoceException("Game not found: {}".format(name))
